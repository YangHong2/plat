...
/** */
    ...
    private static final String SIGN_KEY = "DHLK_E2C";
    /** */
    /**
     * RSA最大加密明文大小
     */
    ...
    public static void main(String[] args) throws  Exception{
        ...
        String  cipherText = encryptedDataOnJava(input, publicKey);
        //加密后的东西
        System.out.println("密文=======" + cipherText);
        String plainText = decryptDataOnJava(cipherText, privateKey);
        System.out.println("解密后明文===== " + plainText);
        String str = "dhlk_e2c";
        System.out.println("\n原文:" + str);
        String signature = sign(str.getBytes(), privateKey);
        boolean status = verify(str.getBytes(), publicKey,signature);
