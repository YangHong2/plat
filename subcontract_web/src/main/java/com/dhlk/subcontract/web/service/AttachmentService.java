...
import com.dhlk.subcontract.web.config.FeignMultipartConfig;
import com.dhlk.subcontract.web.service.fbk.AttachmentServiceFbk;
 ...
 * @Date 2020/3/31
 */
@FeignClient(value = "subcontract-service/attachment", fallback = AttachmentServiceFbk.class,configuration = FeignMultipartConfig.class)
